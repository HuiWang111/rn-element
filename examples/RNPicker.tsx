...
export function BasicPickerExample(): JSX.Element {
...
export function StyledPickerExample(): JSX.Element {
    const [value, setValue] = React.useState('key1');
    return (
        <Picker
...
export function DisabledPickerExample(): JSX.Element {
...
export function DisabledSpecificPickerExample(): JSX.Element {
    const [value] = React.useState('key1');
...
export function DropdownPickerExample(): JSX.Element {
    const [value, setValue] = React.useState('key1');
...
export function DropdownMultilinePickerExample(): JSX.Element {
    const [value, setValue] = React.useState('key1');
...
export function PromptPickerExample(): JSX.Element {
    const [value, setValue] = React.useState('key1');
    return (
        <Picker
            mode="dialog"
...
export function PromptMultilinePickerExample(): JSX.Element {
    const [value, setValue] = React.useState('key1');
    return (
        <Picker
            mode="dialog"
...
// function CustomDropdownArrowColorPickerExample(): JSX.Element {
//     return (
//         <View>
...
export function NoListenerPickerExample(): JSX.Element {
    return (
        <View>
            <Picker>
                <Item label="hello" value="key0" />
            ...
            <Text>
                Cannot change the value of this picker because it update
                selectedValue.
            </Text>
        </View>
    );
...
export function ColorPickerExample(): JSX.Element {
